...
- Пины ADC1 (34, 35, 36, 39) не имеют подтягивающих резисторов и могут использоваться только как входы.
- При использовании ADC2 во время работы Wi-Fi вы получите некорректные значения (обычно 4095).